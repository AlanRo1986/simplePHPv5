...
use App\System\Storage\CacheProvider;
use App\System\Storage\CookieProvider;
use App\System\Storage\FileProvider;
use App\System\Storage\QueueProvider;
use App\System\Storage\SessionProvider;
...
//        var_dump($this->getRouter()->getAppType());
//        var_dump($this->getRouter()->getApp());
//        var_dump($this->getRouter()->getControlExtra());
//        var_dump($this->getRouter()->getControlExtraFile());
//        var_dump($this->getRouter()->getPathInfoUri());
//        var_dump($this->getRouter()->getQueryUri());
//        var_dump($this->getRouter()->getUri());
//        var_dump($this->getRouter()->getAction());
//        var_dump($this->getRouter()->getClass());
//        var_dump($this->getRouter()->getController());
//        var_dump($this->getRouter()->getControllerFile());
//        var_dump($this->getRouter()->getControllerFilePath());
//        var_dump($this->getRouter()->getId());
//        var_dump($this->getRouter()->getMethod());
//        var_dump($this->getRouter()->getVersionCode());
//        var_dump($this->getRouter()->getVersionName());
    ...
    public function run()
    {
        ...
        //控制器初始化
        $file = self::getBasePath() . $this->getRouter()->getControllerFilePath();
        includeFile($file);
//        var_dump($file);
