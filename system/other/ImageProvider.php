...
class ImageProvider extends Provider
{
     ...
     * @throws \Exception
     */
    public function makeThumb($source_path = '',$filename = '' ,$thumb_width = [360,1024])
    {
     ...
     * @throws \Exception
     */
    public function makeCrop($source_path)
    {
     ...
     * @return bool
     */
    public function makeWater($source = "",$water = "",$position = 4)
    {
     ...
     * @throws \Exception
     */
    public function createImageByType($imageFile, $mime){
        switch ($mime){
            case 'image/gif':
     ...
     * @throws \Exception
     */
    protected function getImageFuncType($mime){
        switch ($mime){
            case 'image/gif':
                $fucType = 'gif';
                break;
     ...
     * @throws \Exception
     */
    protected function getImageExt($mime){
        switch ($mime){
            case 'image/gif':
                $ext = 'gif';
                break;
     ...
     * @return int
     */
    protected function getCropHeight()
    {
     ...
     * @return int
     */
    protected function getCropWidth()
    {
