...
abstract class DbCore extends Compact implements DataBaseInterface {
     ...
     * @return array
     */
    protected function get_host_port($host, $default = 3306 )
    {
        $port = $default;
     ...
     * @return array
     */
    public function getAll($query,$output = "ARRAY_A")
    {
     ...
     */
    protected function store_cache($query,$is_insert)
    {
     ...
     * @return float
     */
    protected function timer_get_cur()
    {
     ...
     * @return float
     */
    protected function timer_elapsed($timer_name)
    {
     ...
     * @return string|void
     */
    protected function get_set($params)
    {
        if( !is_array( $params ) )
        {
