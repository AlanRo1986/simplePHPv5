...
class CacheMemcachedHandler implements CacheInterface
{
    ...
    public function getMany($keys)
    {
        ...
        $values = $this->getMemcached()->getMulti($prefixedKeys, null);
    ...
    public function increment($key, $value = 1)
    {
        ...
        return $this->getMemcached()->increment($this->getKey($key), $value);
    }
    ...
    public function decrement($key, $value = 1)
    {
        ...
        return $this->getMemcached()->decrement($this->getKey($key), $value);
    }
