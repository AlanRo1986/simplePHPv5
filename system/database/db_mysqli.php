...
class db_mysqli extends DbCore
{
    ...
    protected static $mysqli_str_err = [
    ...
    public function __construct($user = '', $password = '', $name = '', $host = 'localhost', $encoding = 'utf8')
    {
        parent::__construct();
    ...
    protected function quick_connect($user = '',$password = '',$name = '',$host = 'localhost',$port = '3306', $encoding = 'utf8')
    {
        $return_val = false;
    ...
    protected function connect($user = '',$password = '', $host = 'localhost', $port = false) {
        $return_val = false;
    ...
    protected function select($name = '', $encoding = '') {
